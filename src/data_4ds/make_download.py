...
def main():
    ...
    # Full dataset
    process_raw_csvs(Split.TRAIN)
    process_raw_csvs(Split.TRAIN_SUBSET)
    process_raw_csvs(Split.VAL)
    process_raw_csvs(Split.VAL_SUBSET)
    # process_raw_csvs(Split.TEST)

    # 35% dataset
    process_raw_csvs(Split.TRAIN, use_35=True)
    process_raw_csvs(Split.TRAIN_SUBSET, use_35=True)
    process_raw_csvs(Split.VAL, use_35=True)
    process_raw_csvs(Split.VAL_SUBSET, use_35=True)
