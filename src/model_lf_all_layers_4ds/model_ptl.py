...
from src.model_lf_all_layers_4ds.config import Config
from src.model_lf_all_layers_4ds.config import TRAIN_ARGS_PER_XLSR_SIZE
...
class Model(pl.LightningModule):
    ...
    def __init__(
        ...
        num_layers = configs[0].xlsr_layers
        ...
        for idx in range(self.num_configs):
            ...
            for ds in range(1, self.num_ds):
                dsN_idx = idx + ds * (self.num_configs)
        ...
        HEADER = ["epoch", "input", "loop", "dataset", "config_idx", "loss"]
